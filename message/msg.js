...
Instagram : @sahrulwara_____
Youtube : ARULL OFC
WhatsApp : 6285822347348
...
const nobot = "6283843192208" // Ganti No Bot Kalian
const namabot = "ArullBotz" // Ganti Nama Bot Kalian
const nameown = "ArullOfc" // Ganti Nama Kalian
const numown = "6285822347348" // Ganti Nomor Kalian
const nameowner = "ArullOfc" // Ganti Nama Kalian
const footer = "ArullBotz MD 2022" // Ganti Nama Bot Kalian
const capt = "*By ArullOfc*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/GdXv5LxKfDPHJ4WOH2rNu5" // Ganti Link Group Kalian
const nomorown = "https://wa.me/6285822347348" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan Jika Ada Fitur Yang Eror Silakan Hubungi Owner!!!_*" // Kalau Mau Ganti Aja
const namagrup = "Group Ofc Bot" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "" // Ganti Nomor Gopay Mu
const pulsa = "085822347348" // Ganti No Pulsa Mu
const insta = "sahrulwara_____" // Ganti Nama IG Mu
const github = "Warikrr" // Ganti Nama Github Mu
...
const qris = "https://telegra.ph/file/64b3490fb02f008cae260.jpg"
const nomor = "wa.me/6285822347348"
const tujuhhari = "10.000"
const tigapuluhhari = "20.000"
const setahun = "50.000"
const permanen = "100.000"
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Group Ofc Bot`, url : `${grup}` } },
...
case prefix+'listff': //By ArullOfc
...
*Jika Ingin Order Klick Button Dibawah Atau Ketik ${prefix}formatid*`
			    ...
			    break
case prefix+'rekber': //By ArullOfc
...
 ${rekberh}`
			    ...
			    break
case prefix+'formatid': // By ArullOfc
  reply(`*[ FORMAT FF ]*\n\nID Game = \nNick Game = \nJumlah Diamond = \nPembayaran Via = \n\n*Kirim Formulir Ini Ke ${nomor}*`)
  break
case prefix+'sc': //By ArullOfc
  var teks = `*â”€â”€ ã€Œ SOURCE CODE ã€ â”€â”
 Syarat : Subscribe https://youtube.com/channel/UC1ikkqsPvtWuE_QonsET1yg Dan Screenshot Kirim Ke Owner_`
...
ðŸ˜–ðŸ™`
			    ...
			    break
case prefix+'sewabot': //By ArullOfc
...
break
  ...
  â”œâ”€ â 083843192208
  â”œâ”€ â INSTAGRAM
  â””â”€ â https://www.instagram.com/sahrulwara_____
